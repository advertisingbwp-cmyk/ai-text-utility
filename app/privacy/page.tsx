...
export const metadata: Metadata = {
  title: "Privacy Policy | OmniText Utility",
  description:
    "Learn how OmniText protects your privacy with browser-native client-side processing, zero-logging AI transformations, and minimal data collection.",
  alternates: {
    canonical: "/privacy",
  },
};
    ...
    <div className="max-w-4xl mx-auto py-10 px-4 sm:px-6 space-y-10 text-slate-300">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="p-4 rounded-xl border border-slate-800 bg-slate-900/40 space-y-2">
          ...
          <h2 className="text-sm font-semibold text-white">Client-Side Processing</h2>
        ...
        <div className="p-4 rounded-xl border border-slate-800 bg-slate-900/40 space-y-2">
          ...
          <h2 className="text-sm font-semibold text-white">Zero-Logging AI</h2>
          <p className="text-xs text-slate-400 leading-relaxed">
        ...
        <div className="p-4 rounded-xl border border-slate-800 bg-slate-900/40 space-y-2">
          ...
          <h2 className="text-sm font-semibold text-white">No Sensitive Tracking</h2>
          <p className="text-xs text-slate-400 leading-relaxed">
      ...
      <div className="space-y-8 text-sm leading-relaxed">
        <section className="space-y-3">
          ...
          <p>
            OmniText was purposefully engineered to respect personal privacy and confidentiality. For all offline,
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-white">2. AI Magic Tools Processing</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-white">3. Local Storage & Preferences</h2>
          <p>
            We use browser <code>localStorage</code> exclusively to persist your convenience preferences, such as:
          </p>
          <ul className="list-disc list-inside space-y-1.5 text-slate-400 pl-2">
            <li>Bookmarked favorite tools (e.g. <code>favorite_tools</code>)</li>
            <li>Recently accessed utilities (e.g. <code>recent_tools</code>)</li>
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-white">4. Telemetry & Analytics</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-white">5. Advertising & Third-Party Cookies</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-semibold text-white">6. Contact & Updates</h2>
          <p className="text-slate-400">
